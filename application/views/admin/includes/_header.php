...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin/css/theme-dc-admin.css">
    <!-- RTL -->
...
<div class="wrapper">
    ...
    <aside class="main-sidebar" style="background-color: #1A2426;">
        ...
        <section class="sidebar sidebar-scrollbar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview<?php is_admin_nav_active(['brands', 'update-brand']); ?>">
                    <a href="#">
                        <i class="fa fa-bookmark"></i>
                        <span><?php echo trans("brands"); ?></span>
                        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                    </a>
                    <ul class="treeview-menu">
                        <li class="nav-brands"><a href="<?php echo admin_url(); ?>brands"> <?php echo trans("brands"); ?></a></li>
                    </ul>
                </li>
