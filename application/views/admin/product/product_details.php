    ...
    <div class="col-sm-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <?php $product_variations = $this->variation_model->get_product_variations($product->id);
                    ...
                    <div class="row row-product-details">
                        ...
                        <div class="col-md-9 col-sm-12 right">
                            <?php foreach ($product_variations as $variation):
                                ...
                                $options = $this->variation_model->get_variation_options($variation->id);
                                $option_names = array();
                                if (!empty($options)) {
                                    foreach ($options as $option) {
                                        $option_names[] = get_variation_option_name($option->option_names, $this->selected_lang->id);
                                    }
                                } ?>
                                <div><strong><?php echo html_escape($variation_label); ?>:</strong> <?php echo html_escape(implode(', ', $option_names)); ?></div>
                            <?php endforeach; ?>
                        </div>
                    </div>
                <?php endif; ?>
